...
const NuevoPassword = () => {
  ...
  useEffect(() => {
    const comprobarToken = async () => {
      try {
        await clienteAxios(`/veterinarios/recuperar/${token}`);
        setAlerta({
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        { tokenValido &&
          <><form onSubmit={handleSubmit}>
            ...
            <div className="my-5">
              <input type="submit" value="Guardar nueva contraseña" className="bg-indigo-700 w-full py-3 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto p-10" />
            </div>
