...
const Paciente = ({ paciente }) => {
    ...
    const { email, fecha, sintomas, propietario, nombre, _id } = paciente;

    const formatDate = (date) => {
        const nuevaFecha = new Date(date);
        return new Intl.DateTimeFormat('es-MX', {dateStyle: 'long'}).format(nuevaFecha); //Formato: 1 de enero de 2021
    }
